...
#   - e.g. ('', '', '127.0.0.1', '6800', '') or ('username', 'password', 'localhost', '6801', 'group')
# str(os.environ.get('SCRAPYD_SERVERS'), 'scrapy:secret@scrapyd:6800#default'), "server")

SCRAPYD_SERVERS = [str(os.environ.get('SCRAPYD_SERVERS',
                       None))]
# SCRAPYD_SERVERS = os.environ.get(
#     'SCRAPYD_SERVERS', ['scrapy:secret@scrapyd:6800#default'])
# # [
#     ('scrapy', 'secret', 'scrapyd', '6800', '')
#     os.environ.get('SCRAPYD_SERVERS', 'scrapy:secret@scrapyd:6800#default')
